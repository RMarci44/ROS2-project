...
def generate_launch_description():
    ...
    pkg_bme_ros2_project = FindPackageShare('bme_ros2_project')
    default_rviz_config_path = PathJoinSubstitution([pkg_bme_ros2_project, 'rviz', 'urdf.rviz'])
    ...
    # URDF model path within the bme_ros2_project package
